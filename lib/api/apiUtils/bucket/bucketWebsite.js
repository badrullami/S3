...
* @param {boolean} [options.isList] - indicates if parent is list of children
*   elements, used only in conjunction a singular requiredElem argument
* @param {boolean} [options.checkForAll] - return true only if parent element
*   contains all children elements specified in requiredElem; by default,
*   returns true if parent element contains at least one
* @param {boolean} [options.validateParent] - validate format of parent element
